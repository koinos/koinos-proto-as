    ...
    export class authorize_arguments {
      static encode(message: authorize_arguments, writer: Writer): void {
        ...
        if (call !== null) {
          writer.uint32(18);
          writer.fork();
          koinos.chain.call_target.encode(call, writer);
          writer.ldelim();
        }
      }
      ...
      static decode(reader: Reader, length: i32): authorize_arguments {
        ...
        while (reader.ptr < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2:
              message.call = koinos.chain.call_target.decode(
                reader,
                reader.uint32()
              );
              break;
      ...
      type: koinos.chain.authorization_type;
      call: koinos.chain.call_target | null;

      constructor(
        type: koinos.chain.authorization_type = 0,
        call: koinos.chain.call_target | null = null
      ) {
        this.type = type;
        this.call = call;
      }
